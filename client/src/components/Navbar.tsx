  ...
  return (
    <nav className="bg-white sticky top-0 z-50 border-b border-app-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
        ...
        <Link
          to="/"
          className="flex items-center gap-2 text-[22px] text-medium shrink-0"
        >
          <Bike size={24} /> BazaarBuddy
        </Link>
        <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
          ...
          <div className="flex items-center gap-3">
            {/* cart */}
            <button
              className="relative p-2 rounded-x1"
            ...
            <div className="relative">
              ...
              {userMenuOpen && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2.5 w-56 z-50 bg-white rounded-xl shadow-lg border border-app-border py-2 animate-fade-in">
                    {user && (
