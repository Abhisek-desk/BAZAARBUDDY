...
const Hero = () => {
  return (
    ...
    <div className="relative max-w-7xl mxx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="max-w-xl xl:pl-10">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-white leading-tight mb-5">Nourish your Home with 
